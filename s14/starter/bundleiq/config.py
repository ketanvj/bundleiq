...
# ---------------------------------------------------------------------------
# S14 TODO: Fill in INJECTION_PATTERNS and PII_PATTERNS.
#
# INJECTION_PATTERNS: regex strings (case-insensitive) that detect prompt
# injection / jailbreak attempts in the raw customer message.
# Add one pattern per line. Examples of what to catch:
#   "ignore all previous instructions"
#   "you are now <persona>"
#   "roleplay as ..."
#   "tell me your system prompt"
#
# PII_PATTERNS: regex strings (NOT case-insensitive) that detect Aadhaar
# and PAN card numbers. DPDP Act 2023 prohibits processing these identifiers.
...
INJECTION_PATTERNS: list[str] = []   # TODO: add injection-detection regex patterns

PII_PATTERNS: list[str] = []         # TODO: add Aadhaar and PAN regex patterns
