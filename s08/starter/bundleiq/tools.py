...
Goal
  Connect the BundleIQ agent to the MCP server built in Session 7
  ...
  from Session 5 -- only how query_plans/query_promotions are sourced changes.
...
Run when done
  python -m bundleiq.agent   (from inside s08/starter/)
"""
import asyncio
import sys
...
# "bundleiq") to a connection config. For a stdio server, the config needs:
#   "transport": "stdio"
