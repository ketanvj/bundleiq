...
#
# Why S6 is excluded for BundleIQ:
#   S6 (Specialized Advice) fires on personalised recommendation queries like
#   "Which plan is best for me?" LlamaGuard is correct that a general AI
#   shouldn't answer this, but BundleIQ's COMPLEX routing already handles
#   it: COMPLEX → escalate → TeleConnect advisor. Blocking at the guard
#   gives a worse customer experience than the escalation path.
#
